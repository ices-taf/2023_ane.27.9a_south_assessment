...
mdb_compi <- mfdb('Iber', db_params=list(dbname="mf"))
#gd <- gadget_directory("Anchovy2021_withLDandALK2020_1_2_data")
gd <- gadget_directory("Anchovy2023_def_estesi_conpelago_def_autom_catchkilos")
...
for (i in 1989:2013){
  for (j in 1:4){
  bioq<-readWorksheetFromFile(paste("../DATOS/Taledas_allfleets_1988_2016/BOQUERON_ALK_",i,".xls",sep=""), sheet = paste(j,"Q",sep=""), header = F, startCol = 9, 
                           startRow = 2, endCol = 9, 
                           endRow = 2, useCachedValues=T)*0.001 #Para que quede en toneladas (está en kilos)
numberq<-readWorksheetFromFile(paste("../DATOS/Taledas_allfleets_1988_2016/BOQUERON_ALK_",i,".xls",sep=""), sheet = paste(j,"Q",sep=""), header = F, startCol = 9, 
...
for (i in c(1999,2001:2003,2005:2009)){
  ...
  a<-readWorksheetFromFile("../DATOS/Acústica en 9aS_TallasyEdades.xls", sheet = paste(i,"Port",sep=""), 
...
for (i in c(2010,2013,2014)){
  ...
  a<-readWorksheetFromFile("../DATOS/Acústica en 9aS_TallasyEdades.xls", sheet = paste(i,"Port",sep=""), 
                           ...
                           endRow = 35, useCachedValues=TRUE)
  b<-readWorksheetFromFile("../DATOS/Acústica en 9aS_TallasyEdades.xls", sheet = paste(i,"Port",sep=""), 
                           header = F, startCol = 9, 
                           startRow = 2, endCol = 9, 
...
for (i in c(2015:2023)){
  ...
  b<-readWorksheetFromFile(paste("../DATOS/PELAGO/Pelago",i,".xls",sep=""), sheet = "Sheet1", 
...
mybiglist$Pelago2003$year <-2002
  ...
  a<-readWorksheetFromFile("../DATOS/PELAGO/ANE_PELAGO15_Results.xls", sheet = "9a S", 
                           header = TRUE, startCol = 13, 
 ...
 # b<-readWorksheetFromFile(paste("/home/marga/GADGET/DATOS/PELAGO/Pelago",i,".xls",sep=""), sheet = "Sheet1", 
  ...
  a<-readWorksheetFromFile("../DATOS/PELAGO/PELAGO16_ANE_RESULTS_FINAL.xls", sheet = "AbundanceBiomassANE_FINAL", 
                           header = TRUE, startCol = 1, 
...
i<-2016
  ...
  a<-readWorksheetFromFile("../DATOS/PELAGO/results-ane-pel17_fv.xlsx", sheet = "CAD", 
                           header = TRUE, startCol = 1, 
  ...
  a<-readWorksheetFromFile("../DATOS/PELAGO/results-ANE-PEL18.xlsx", sheet = "algarve+cadiz", 
                           header = TRUE, startCol = 1, 
                           startRow = 1, endCol = 2, 
  ...
  a<-readWorksheetFromFile("../DATOS/PELAGO/results-ANE-PEL19.xlsx", sheet = "algarve+cadiz", 
                           header = TRUE, startCol = 1, 
                           startRow = 1, endCol = 2, 
                           endRow = 30, useCachedValues=TRUE)
  i<-2019
  ...
  a<-readWorksheetFromFile("../DATOS/PELAGO/results-ANE-PEL20.xlsx", sheet = "algarve+cadiz", 
                           header = TRUE, startCol = 1, 
                           startRow = 1, endCol = 2, 
                           endRow = 30, useCachedValues=TRUE)
  i<-2020
  ...
  a<-readWorksheetFromFile("../DATOS/PELAGO/results-ANE-PEL21.xlsx", sheet = "algarve+cadiz", 
                           header = TRUE, startCol = 1, 
                           startRow = 1, endCol = 2, 
                           endRow = 30, useCachedValues=TRUE)
  i<-2021
  ...
  a<-readWorksheetFromFile("../DATOS/PELAGO/results-ANE-PEL22.xlsx", sheet = "algarve+cadiz", 
                           header = TRUE, startCol = 1, 
                           startRow = 1, endCol = 2, 
                           endRow = 30, useCachedValues=TRUE)
  i<-2022
  ...
  a<-readWorksheetFromFile("../DATOS/PELAGO/results-ANE-PEL23.xlsx", sheet = "algarve+cadiz", 
                           header = TRUE, startCol = 1, 
                           startRow = 1, endCol = 2, 
                           endRow = 30, useCachedValues=TRUE)
  i<-2023
...
name<-"alPelago2014" 
d<-readWorksheetFromFile("../DATOS/PELAGO/PELAGO14_ANE_ALK_WCOAST_sg.xlsx", sheet = "alg", 
                         header = TRUE, startCol = 6, 
                         startRow = 7, endCol = 9, 
                         endRow = 22, useCachedValues=TRUE)
c<-readWorksheetFromFile("../DATOS/PELAGO/PELAGO14_ANE_ALK_WCOAST_sg.xlsx", sheet = "cad", 
                         header = TRUE, startCol = 6, 
                         startRow = 7, endCol = 9, 
                         endRow =22, useCachedValues=TRUE)
d[is.na(d)] <- 0
...
name<-"alPelago2015" 
d<-readWorksheetFromFile("../DATOS/PELAGO/ANE_PELAGO15_Results_sg.xlsx", sheet = "Algarve", 
                         header = TRUE, startCol = 17, 
                         startRow = 4, endCol = 20, 
                         endRow = 31, useCachedValues=TRUE)
c<-readWorksheetFromFile("../DATOS/PELAGO/ANE_PELAGO15_Results_sg.xlsx", sheet = "CADIZ", 
                         header = TRUE, startCol = 17, 
                         startRow = 4, endCol = 20, 
                         endRow =31, useCachedValues=TRUE)
d[is.na(d)] <- 0
...
name<-"alPelago2016" 
a<-readWorksheetFromFile("../DATOS/PELAGO/PELAGO16_ANE_RESULTS_FINAL_sg.xlsx", sheet = "ALKs_FINAL", 
                         header = TRUE, startCol = 8, 
...
# catchldist14<-readWorksheet(loadWorkbook("../DATOS/lengthdist1415.xls"), sheet="Sheet2")
# catchldist14<-matrix(as.numeric(as.character(catchldist14$X2014)),  ncol=6,byrow=T)
# catchldist15<-readWorksheet(loadWorkbook("../DATOS/lengthdist1415.xls"), sheet="Sheet1")
# catchldist16<-readWorksheet(loadWorkbook("../DATOS/lengthdist1415.xls"), sheet="Sheet3")
...
#                                          # startRow = 14, endCol = 13,
#                                          # endRow = 14, useCachedValues=TRUE)
catches20231cakg<-readWorksheetFromFile("../DATOS/Taledas_allfleets_1988_2016/Ane279a_9aS_Prov Landings Jan-June 2023.xls", sheet="Sheet1",
                                        header = F, startCol = 7,
                                        startRow = 20, endCol = 7,
                                        endRow = 20, useCachedValues=TRUE)
catches20232cakgpre<-readWorksheetFromFile("../DATOS/Taledas_allfleets_1988_2016/Ane279a_9aS_Prov Landings Jan-June 2023.xls", sheet="Sheet1",
                                           header = F, startCol = 8,
...
mfdb_import_sampling_type(mdb_compi, data.frame(
  id = 1:25,
  name = c('SEA', 'pelago','ecocadiz', 'ecocadiz0813','sar','pelago_comp','ecocadiz_comp','pelago_bio','ecocadiz_bio', 'sar_bio','ecocadizrec_bio','ecocadiz_rec_comp','bocadeva_bio','alkcatches_comp', 'arsa_comp','arsa_bio','SEAS','SEAS2','arsa_compld','ecocadiz_comp_ld','ecocadiz_comp_ald','pelago_comp_ld','pelago_comp_ald', 'ecocadiz_rec_comp_ald','ecocadiz_rec_comp_ld'),
  description = c('Sea sampling', 'pelago','ecocadiz', 'ecocadiz0813','sar','pelago_comp','ecocadiz_comp','pelago_bio','ecocadiz_bio','sar_bio','ecocadizrec_bio','ecocadiz_rec_comp','bocadeva_bio','alkcatches_comp', 'arsa_comp','arsa_bio','seas2','seas3','arsa_solo_length','ecocadiz_comp_ld','ecocadiz_comp_ald','pelago_comp_ld','pelago_comp_ald','ecocadiz_rec_comp_ald','ecocadiz_rec_comp_ld')))
mdb<-mdb_compi
...
mfdb_import_survey(mdb,
                   ...
                   pelago.aldist)
mfdb_import_survey(mdb,
                   data_source = 'example-anchovy-eoccasizrec.aldist',
                   ecocadiz_rec.aldist)
...
aggdata <- mfdb_sample_count(mdb, c('age','length'), c(list(
  sampling_type='ecocadiz_rec_comp_ld', length = mfdb_interval("len", seq(3,22,0.5))),
  defaults))


gadget_dir_write(gd, gadget_likelihood_component("catchdistribution",
                                                 name = "ldist.ecocadizrec.noage",                                                   
                                                 stocknames = c("anch"),                                           
                                                 weight = 1,
                                                 fleetnames = c("ECO-REC"),
                                                 data = aggdata[[1]]
))
gadget_dir_write(gd, gadget_file("Aggfiles/catchdistribution.ldist.ecocadizrec.noage.age.agg", list(list(all=c(0,3)))))
...
aggdata<-mfdb_sample_count(mdb,c("vessel"),c(
  ...
  list(vessel=mfdb_group(seine="1.RSH"),sampling_type='ecocadizrec_bio'),
  defaults))
aggdata[[1]]$vessel<-"ECO-REC"
aggdata[[1]]$number<-1
gadget_dir_write(gd, gadget_fleet_component(
  'totalfleet',
  name = 'ECO-REC',
